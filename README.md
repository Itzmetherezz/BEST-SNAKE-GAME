...
## Overview
**BEST SNAKE GAME USING C#** has been made purely on C# WPF without any other editors like unity. You move a snake around and eat all the food you can find.
...
## Overview of Steps
- Import the assets of the snake and food.
- Made the grid.
...
- Made the game end by the intersection of the head of the snake and its body or the border of the.



Tutorial:
   https://youtu.be/uzAXxFBbVoE?si=GyY_FqA-uLeR5oru
